...
```{r merged,out.width = "70%",fig.cap = "Reported deaths number in European Union."}
...
```
For a better understanding what impact that virus bring to, figure \@ref(fig:gcompare) compared to total GDP of 19 countries in European area, Belgium’s GDP have a same moving trend as European countries. However, in the last two quarter that Belgium has wider variations than normal.
...
```{r gcompare,out.width = "70%",fig.cap = "GDP comparison between Belgium and European Union(19 countries)"}
...
```{r unemcom,out.width = "70%",fig.cap = "Comparison of Unemployment Rate between Belgium and Euro area"}
